    ...
    return (
        <div className="text-gray-200 my-20 p-3 lg:p-0 flex flex-col lg:flex-row justify-between gap-10 ">
            ...
            <div className="w-auto lg:w-[60%] space-y-3 pt-2"> 
                <h1 className="text-xl lg:text-5xl font-extrabold ">I&apos;m Arafat Sunny <br /> 
                <Typewriter
            ...
            <div className="w-auto lg:w-[30%] rounded-xl   ">
                <img className="h-[360px] w-72 m-4 border-2 border-gray-400  rotate-12 hover:rotate-0  rounded-2xl object-cover 
                hover:transition
                   " 
